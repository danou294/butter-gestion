...
Chaque document = une section avec un type (guides, coups_de_coeur, videos, decide, guide_collections).
"""
...
VALID_SECTION_TYPES = ('guides', 'coups_de_coeur', 'videos', 'decide', 'guide_collections')
